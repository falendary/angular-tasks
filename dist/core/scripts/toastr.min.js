!function () {
    ...
    function t(t, e, s, n, o, r, a) {
        ...
        function l(t, e, s) {
            var n = d().iconClasses.error;
            return m(n, t, e, s)
        }

        function c(t, e, s) {
            var n = d().iconClasses.info;
            return m(n, t, e, s)
        }

        function u(t, e, s) {
            var n = d().iconClasses.success;
            return m(n, t, e, s)
        }

        function p(t, e, s) {
            var n = d().iconClasses.warning;
            return m(n, t, e, s)
        }
        ...
        function g(e, s) {
            ...
            i && !i.deleting && (i.deleting = !0, i.isOpened = !1, t.leave(i.el).then(function () {
                ...
                var e = r.maxOpened;
                e && O.length >= e && O[e - 1].open.resolve(), o() && (C.remove(), C = null, w = a.defer())
            }))
        }
        ...
        function f(e) {
            ...
            return t.enter(C, s).then(function () {
                w.resolve()
            }), w.promise
        }
        ...
        function v(s) {
            function r() {
                return m.autoDismiss && m.maxOpened && O.length > m.maxOpened
            }
            ...
            function l() {
                ...
                var e = {toastId: h++, isOpened: !1, scope: n.$new(), open: a.defer()};
                return e.iconClass = s.iconClass, s.optionsOverride && (angular.extend(m, t(s.optionsOverride)), e.iconClass = s.optionsOverride.iconClass || e.iconClass), i(e, s, m), e.el = c(e.scope), e
            }
            ...
            function u() {
                return m.maxOpened && O.length <= m.maxOpened || !m.maxOpened
            }

            function p() {
                var t = m.preventDuplicates && s.message === T, e = m.preventOpenDuplicates && B[s.message];
                return t || e ? !0 : (T = s.message, B[s.message] = !0, !1)
            }

            var m = d();
            if (!p()) {
                var v = l();
                if (O.push(v), r())for (var w = O.slice(0, O.length - m.maxOpened), x = 0, $ = w.length; $ > x; x++)g(w[x].toastId);
                return u() && v.open.resolve(), v.open.promise.then(function () {
                    f(m).then(function () {
                        if (v.isOpened = !0, m.newestOnTop)t.enter(v.el, C).then(function () {
                            v.scope.init()
                        }); else {
                            var e = C[0].lastChild ? angular.element(C[0].lastChild) : null;
                            t.enter(v.el, C, e).then(function () {
                                v.scope.init()
                            })
                        }
                    })
